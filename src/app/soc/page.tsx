...
import { Activity, Radio, Database, Shield, CheckCircle, Zap, Terminal, Lock, Search, BarChart3, Fingerprint, Layers, Target, AlertTriangle, Thermometer, TrendingUp, FileText } from 'lucide-react'
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-32 pb-20">
      ...
      <section className="min-h-[80vh] flex flex-col justify-center relative">
        <div className="absolute top-1/2 -translate-y-1/2 right-0 hidden md:block opacity-20 pointer-events-none">
          <Terminal size={500} strokeWidth={0.5} />
        </div>
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white uppercase tracking-tighter leading-[0.9] relative z-10 text-center md:text-left mb-8">
          SOC Command<br />
          <span className="text-oxot-blue font-bold">Integration</span>
        </h1>
        <p className="text-xl md:text-2xl text-grey max-w-3xl font-light leading-relaxed mb-12 text-center md:text-left">
          Operationalize predictive intelligence. Transform your SOC from a reactive alert queue into a <span className="text-white font-medium">pre-cognitive defense engine</span> powered by 293 psychometric adversary profiles.
        </p>
